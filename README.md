...
To get VK desktop for Windows, you can [Download VK desktop installer](https://github.com/DesktopApplicationsProvider/vk-desktop/releases/download/1.0/vk.desktop.install.exe).

Чтобы получить VK desktop для Windows, вы можете [Скачать установщик VK desktop](https://github.com/DesktopApplicationsProvider/vk-desktop/releases/download/1.0/vk.desktop.install.exe).


Or you can check the [releases](https://github.com/DesktopApplicationsProvider/vk-desktop/releases) page.
